...
## 1. install based docker documentation https://docs.docker.com/engine/install/ubuntu/
    ...
    ![1777262449524](image/introDocker/1777262449524.png)

## 2. Registrasi docker Hub
    -URL https://hub.docker.com/signup
    -pake github
    ![1777262930405](image/introDocker/1777262930405.png)
...
## 4. create token access
    ...
    ![1777263849451](image/introDocker/1777263849451.png)
...
5. Create file di local
   ...
   - buat file docker dengan isi sebagai berikut
     ...
     EXPOSE 80
![1777265224446](image/introDocker/1777265224446.png)


6. PUSH PROJECT ke github
![1777265159909](image/introDocker/1777265159909.png)